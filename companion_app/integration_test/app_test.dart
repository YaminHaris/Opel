...
void main() {
  ...
  testWidgets('saves a contact and it appears in the database',
    ...
    // Confirm it actually landed in the (emulated) database.
    final snapshot =
        await FirebaseDatabase.instance.ref('helmet_01/contacts/0').get();
  ...
  testWidgets('rejects an invalid number and does not write to the database',
    ...
    final snapshot =
        await FirebaseDatabase.instance.ref('helmet_01/contacts').get();
